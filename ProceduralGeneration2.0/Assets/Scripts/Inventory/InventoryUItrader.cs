...
public class InventoryUItrader : MonoBehaviour, IInventoryUI
{
    ...
    public void UpdateUI()
    {
        for (int i = 0; i < inventory.SlotsCount; i++)
        {
            ...
            inventorySlots[i].transform.Find("Quantity").GetComponent<TMP_Text>().text = inventory.Slots[i].InventoryItem.buyPrice + "$";
